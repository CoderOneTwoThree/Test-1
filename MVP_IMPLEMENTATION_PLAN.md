...
1. Define the minimal data storage schema for workouts and sets (including exercise, load, reps, and timestamp) and persist it using a simple local store such as a lightweight database or structured files.
